...
namespace JetBrains.CachingProxy
{
  ...
  public class RemoteProxy
  {
    ...
    public RemoteProxy(IOptions<CachingProxyConfig> config, ProxyHttpClient httpClient, ResponseCache responseCache,
      CachingProxyMetrics metrics, TimeProvider timeProvider, ILoggerFactory loggerFactory)
    {
      myLogger = loggerFactory.CreateLogger<RemoteProxy>();
